...
stellar-agent mainnet agent-wallet enable --address G... --max-balance 25 --daily-limit 5 --per-tx-limit 1 --asset XLM --allow-destination G... --arm --i-understand-real-funds --json
